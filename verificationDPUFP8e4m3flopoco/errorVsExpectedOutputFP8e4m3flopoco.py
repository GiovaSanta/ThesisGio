...
# Files
input_file = "output_file.txt" #comes from the output of the dpu testbench
...
plt.title("Absolute Error vs Expected Output (float8_e4m3 DPU)")
plt.xlabel("Expected Output (Golden Value)")
plt.ylabel("Absolute Error")
plt.grid(True)
plt.tight_layout()
plt.show()
plt.savefig("float8_dpu_error_plot.png", dpi=300)

print("\n✅ Plot saved as 'float8_dpu_error_plot.png'")
print("📄 Debug log saved as 'float8_dpu_debug_log.txt'")
